...
public class ContextUtility implements java.io.Serializable {
	...
	public static void initializeCronMetadata(ProcessContext context, JSONArray jsonArray) throws JsonProcessingException  {
	...
	private static void updateVariable(ProcessContext context, 
    	...
    	switch (key) {
			case "indiepubUpdateDistributionRightsUrl":
				setProcessVariable(context, "indiepubUpdateDistributionRightsUrl", value);
			break;
			case "cronIndiepubUpdateDistributionRights":
			    boolean run = "Y".equalsIgnoreCase(value); 
				setProcessVariable(context, "cronIndiepubUpdateDistributionRights", run);
			break;
		}
